...
### Op de mixer - CLAUDIA (Leadzang)

Preset voor warme, diepe vrouwenstem (mezzo/alt). Zingt typisch in Am, Bbm, Bb, Cm.
...
```
Grondtoon (200-400Hz)     →  De noot die je zingt
...
**Belangrijke les:** Om een stem beter hoorbaar te maken, boost je NIET de grondtoon (dat maakt het modderig). Je boost de harmonischen (2-4kHz) - daar zit de herkenbaarheid.
...
#### Combinatie met compressie

Voor Claudia's stem (dynamisch, gaat van zacht naar krachtig):
